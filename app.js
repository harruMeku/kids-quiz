...
// 小3漢字の書き練習用 例文マップ（word → 例文）
// 対象の漢字を【】で囲んで、文脈から意味がわかるようにする
const KANJI_WRITE_EXAMPLES = {
  "丁寧": "先生に【ていねい】な字で手紙を書いた。",
  "世界": "【せかい】にはいろいろな国がある。",
  "両方": "右と左の【りょうほう】を見てからわたろう。",
  "主人公": "この物語の【しゅじんこう】はとても勇かんだ。",
  "乗る": "バスに【のる】前にきっぷを買う。",
  "予定": "日曜日の【よてい】を手帳に書いた。",
  "事": "大切な【こと】はメモしておこう。",
  "仕事": "お父さんは朝から【しごと】に出かけた。",
  "他": "【ほか】のやり方もためしてみよう。",
  "時代": "むかしの【じだい】の人のくらしを調べた。",
  "住む": "わたしは東京に【すむ】ことになった。",
  "使う": "はさみは正しく【つかう】ようにしよう。",
  "係": "花だんの水やり【かかり】になった。",
  "二倍": "３の【にばい】は６になる。",
  "全部": "プリントは【ぜんぶ】やりおわった。",
  "道具": "工作に使う【どうぐ】をじゅんびした。",
  "写真": "遠足で友だちと【しゃしん】をとった。",
  "列": "まっすぐな【れつ】にならんで歩いた。",
  "助ける": "友だちが転んだので【たすける】ことにした。",
  "勉強": "毎日すこしずつ【べんきょう】する。",
  "動く": "風がふくと風車が【うごく】。",
  "勝つ": "サッカーのしあいで【かつ】ことができた。",
  "化学": "理科の【かがく】の実験はおもしろい。",
  "区": "わたしは練馬【く】に住んでいる。",
  "医者": "かぜをひいたので【いしゃ】に行った。",
  "去年": "【きょねん】の夏はプールにたくさん行った。",
  "反対": "兄と意見が【はんたい】になった。",
  "取る": "棚の上の本を【とる】。",
  "受ける": "来月テストを【うける】。",
  "番号": "教室のロッカーには【ばんごう】がついている。",
  "向く": "太陽の方を【むく】とまぶしい。",
  "君": "【きみ】のかいた絵はとてもじょうずだ。",
  "味": "お母さんの作る料理は【あじ】がいい。",
  "命": "すべての【いのち】を大切にしよう。",
  "平和": "【へいわ】な世界を願っている。",
  "品物": "お店にはたくさんの【しなもの】がならんでいる。",
  "委員": "学級【いいん】に選ばれた。",
  "商店": "駅の近くの【しょうてん】でおかしを買った。",
  "問題": "算数の【もんだい】をとく。",
  "坂道": "学校の前の【さかみち】をのぼる。",
  "中央": "体育館の【ちゅうおう】に集まった。",
  "始まる": "授業が【はじまる】前にじゅんびをする。",
  "守る": "交通ルールを【まもる】ことが大切だ。",
  "安い": "この本は【やすい】のにおもしろい。",
  "実": "秋になると木に【み】がなる。",
  "お客さん": "今日はいえに【おきゃくさん】が来る。",
  "宮": "京都には古い【みや】がたくさんある。",
  "宿題": "【しゅくだい】を先にやってから遊ぶ。",
  "寒い": "冬の朝はとても【さむい】。",
  "届ける": "となりの家に手紙を【とどける】。",
  ...
  "海岸": "夏休みに【かいがん】で遊んだ。",
  "島": "日本にはたくさんの【しま】がある。",
  "九州": "おじいちゃんは【きゅうしゅう】に住んでいる。",
  "手帳": "お母さんは【てちょう】に予定を書く。",
  "幸せ": "家族がみんな元気で【しあわせ】だ。",
  "温度": "今日の【おんど】は三十度もある。",
  "車庫": "お父さんの車は【しゃこ】に入っている。",
  "庭": "【にわ】にきれいな花がさいた。",
  "入学式": "四月に【にゅうがくしき】があった。",
  "役": "劇で大事な【やく】をもらった。",
  "待つ": "駅で電車を【まつ】。",
  "急ぐ": "学校におくれそうなので【いそぐ】。",
  "息": "走ったあとは【いき】が切れる。",
  "悪い": "人の【わるい】ところばかり見てはいけない。",
  "悲しい": "大すきなペットが死んで【かなしい】。",
  "想像": "どんな未来になるか【そうぞう】してみよう。",
  "意味": "知らないことばの【いみ】をじしょで調べる。",
  "感じる": "春のあたたかさを【かんじる】。",
  "場所": "集合する【ばしょ】を確かめた。",
  "打つ": "ボールをバットで【うつ】。",
  "投げる": "友だちにボールを【なげる】。",
  ...
  "旅行": "夏休みに家族で【りょこう】に行く。",
  "家族": "【かぞく】みんなでごはんを食べる。",
  "昔": "おばあちゃんは【むかし】の話をしてくれた。",
  "暗い": "夜道は【くらい】から気をつけよう。",
  "暑い": "夏はとても【あつい】のでたくさん水を飲む。",
  "暖かい": "春になると【あたたかい】日がふえる。",
  "曲がる": "この道をまっすぐ行って、右に【まがる】。",
  "有名": "あの人はとても【ゆうめい】な画家だ。",
  "服": "新しい【ふく】を買ってもらった。",
  "期間": "なつ休みの【きかん】は長い。",
  "黒板": "先生が【こくばん】に問題を書いた。",
  "柱": "この家は太い【はしら】でささえられている。",
  "屋根": "雨が【やね】を打つ音がきこえる。",
  "植える": "はたけにトマトのなえを【うえる】。",
  "授業": "三時間目の【じゅぎょう】は音楽だ。",
  "様子": "友だちの【ようす】がいつもとちがう。",
  "横": "道路をわたるときは【よこ】を見る。",
  "橋": "川にかかる大きな【はし】をわたる。",
  "次": "【つぎ】の問題にすすもう。",
  "歯": "毎日ていねいに【は】をみがく。",
  "死ぬ": "金魚が【しぬ】と悲しい気持ちになった。",
  "氷": "冬になると池に【こおり】がはる。",
  "決める": "遠足の行き先をみんなで【きめる】。",
  "油": "フライパンに【あぶら】をしく。",
  "波": "海に大きな【なみ】が来た。",
  "注意": "先生の【ちゅうい】をよく聞く。",
  "泳ぐ": "プールで25メートル【およぐ】。",
  "太平洋": "日本の東がわには【たいへいよう】がある。",
  "流れる": "川の水が速く【ながれる】。",
  "消す": "教室を出るとき電気を【けす】。",
  "深い": "このプールは【ふかい】ので注意しよう。",
  "温かい": "お母さんが【あたたかい】スープを作ってくれた。",
  "港": "大きな船が【みなと】に止まっている。",
  "湖": "山の中に美しい【みずうみ】がある。",
  "お湯": "カップめんに【おゆ】を入れる。",
  "漢字": "毎日【かんじ】の練習をしている。",
  "石炭": "むかしは【せきたん】で電車を走らせていた。",
  "動物": "【どうぶつ】園でパンダを見た。",
  "野球": "友だちと公園で【やきゅう】をした。",
  "自由": "夏休みの【じゆう】研究でロボットを作った。",
  "申す": "自分の名前を【もうす】。",
  "畑": "おじいちゃんの【はたけ】で野菜をとった。",
  "病院": "かぜがひどいので【びょういん】に行った。",
  "出発": "朝七時に学校を【しゅっぱつ】する。",
  "登る": "みんなで山を【のぼる】。",
  "皮": "みかんの【かわ】をむく。",
  "お皿": "料理を【おさら】にもりつける。",
  "相手": "話すときは【あいて】の目を見よう。",
  "県": "わたしの住んでいる【けん】は人口が多い。",
  "着る": "寒い日は厚い上着を【きる】。",
  "短い": "この鉛筆はずいぶん【みじかい】。",
  "研究": "昆虫の【けんきゅう】をしている。",
  "礼": "お【れい】のことばをきちんと言おう。",
  "神様": "お正月に【かみさま】にお願いをした。",
  "お祭り": "夏の【おまつり】で花火を見た。",
  "幸福": "みんなが【こうふく】になれますように。",
  "秒": "百メートルを十五【びょう】で走った。",
  "文章": "【ぶんしょう】を書くときは主語をはっきりさせる。",
  "童話": "【どうわ】を読んで感想文を書いた。",
  "笛": "音楽の時間に【ふえ】をふいた。",
  "第一": "【だいいち】に大事なのは健康だ。",
  "鉛筆": "【えんぴつ】を正しく持って字を書く。",
  "平等": "だれに対しても【びょうどう】にせっする。",
  "箱": "プレゼントを【はこ】に入れてわたした。",
  "学級": "【がっきゅう】のみんなで話し合いをした。",
  "終わる": "今日の授業はこれで【おわる】。",
  "緑": "春になると木々が【みどり】に色づく。",
  "練習": "ピアノの【れんしゅう】を毎日する。",
  "羊": "牧場で【ひつじ】の毛をかった。",
  ...
  "薬": "ねつが出たので【くすり】を飲んだ。",
  "血": "転んでひざから【ち】が出た。",
  "表": "カレンダーの【おもて】に予定を書いた。",
  "詩": "国語の時間に【し】を書いた。",
  "調べる": "分からないことは図書館で【しらべる】。",
  "相談": "こまったことがあったら先生に【そうだん】しよう。",
  "豆": "おせち料理には黒い【まめ】が入っている。",
  "負ける": "しあいに【まける】のはくやしい。",
  "起きる": "朝六時に【おきる】。",
  "道路": "【どうろ】を横断するときは信号を守る。",
  "身体": "うんどうをして【しんたい】をきたえる。",
  "自転車": "【じてんしゃ】で学校まで行く。",
  "軽い": "アルミのかんは【かるい】。",
  "農業": "この地方では【のうぎょう】がさかんだ。",
  "返す": "借りた本を図書館に【かえす】。",
  "追いかける": "犬が猫を【おいかける】。",
  "送る": "おばあちゃんに手紙を【おくる】。",
  "速い": "新幹線はとても【はやい】。",
  "進む": "前に向かって一歩ずつ【すすむ】。",
  "遊ぶ": "公園で友だちと【あそぶ】。",
  "運動": "毎朝【うんどう】をして元気になろう。",
  "全部": "おかしを【ぜんぶ】食べてしまった。",
  "都会": "【とかい】はビルがたくさんある。",
  "心配": "テストの結果が【しんぱい】だ。",
  "お酒": "大人になったら【おさけ】が飲める。",
  "重い": "ランドセルが【おもい】のでつかれた。",
  "鉄": "【てつ】でできた橋はとてもがんじょうだ。",
  "銀行": "お年玉を【ぎんこう】にあずけた。",
  "開ける": "窓を【あける】とすずしい風が入ってきた。",
  "病院": "虫歯の治りょうで【びょういん】に行った。",
  "太陽": "【たいよう】が東からのぼる。",
  "階段": "【かいだん】をのぼって三階に行く。",
  "集める": "きれいな石を【あつめる】のがすきだ。",
  "面白い": "この本はとても【おもしろい】。",
  "問題": "先生がむずかしい【もんだい】を出した。",
  "飲む": "朝ごはんのとき牛乳を【のむ】。",
  "図書館": "学校の【としょかん】で本をかりた。",
  "駅": "電車に乗るために【えき】に行く。",
  "鼻": "花のにおいを【はな】でかいだ。",
};
...
function generateKanjiWriteQuestions(category) {
  ...
  const selected = weightedSelect(pool, currentProfile, category.id, QUESTIONS_PER_ROUND);
  return selected.map(s => {
    const example = KANJI_WRITE_EXAMPLES[s.item.word] || '';
    return {
      type: 'numberReading',
      id: s.id,
      label: `${s.item.grade}年生の漢字（書き）`,
      question: '',
      questionHtml: example
        ? `<div style="font-size:0.55em;color:#555;line-height:1.8;margin-bottom:15px;background:#f8f8f8;padding:12px 16px;border-radius:10px;border-left:4px solid #2196f3;">${example}</div><div>「${s.item.wordReading}」を 漢字で書こう</div>`
        : `<div>「${s.item.wordReading}」を 漢字で書こう</div>`,
      answer: s.item.word,
      display: '',
      hint: ''
    };
